...
# ── PROMPT TEMPLATE ─────────────────────────
PROMPT_TEMPLATE = r'''あなたはローカルビジネス（美容室・整骨院・個人店など）のマーケティングを専門とする **コンサルタント兼リサーチャー** です。
...
3. **書式** 一人称『私』視点の気づきメモ。ただし **美容師としてではなく、マーケティングコンサルタントとしての視点** で書く。絵文字・ハッシュタグ・セールス語禁止。
